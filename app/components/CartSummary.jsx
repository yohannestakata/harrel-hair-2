...
function CartCheckoutActions({checkoutUrl, cart}) {
  ...
  return (
    <div>
      <h4 className="font-semibold mt-2 text-xl">Checkout</h4>
      <div className="mb-4 mt-2 grid grid-cols-2 gap-2">
        <button
          onClick={handleWhatsAppClick}
          className="bg-green-500 hover:bg-green-600 text-white font-medium py-3 px-6 rounded-lg flex items-center justify-center gap-2 transition-colors disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
        >
          <svg
        ...
        <button
          ...
          className="bg-gradient-to-r from-purple-700 to-pink-700 text-white font-medium py-3 px-6 rounded-lg flex items-center justify-center gap-2 transition-colors disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer hover:from-purple-800 hover:to-pink-800"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
